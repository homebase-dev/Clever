...
class BlogEntriesControllerTest < ActionController::TestCase
  ...
  test "should create blog_entry" do
    assert_difference('BlogEntry.count') do
      post :create, blog_entry: { published: @blog_entry.published, text: @blog_entry.text, title: @blog_entry.title, user_id: @blog_entry.user_id }
    end
  ...
  test "should update blog_entry" do
    patch :update, id: @blog_entry, blog_entry: { published: @blog_entry.published, text: @blog_entry.text, title: @blog_entry.title, user_id: @blog_entry.user_id }
    assert_redirected_to blog_entry_path(assigns(:blog_entry))
  end
