...
class FaqsControllerTest < ActionController::TestCase
  ...
  test "should create faq" do
    assert_difference('Faq.count') do
      post :create, faq: { priority: @faq.priority, published: @faq.published, text: @faq.text, title: @faq.title }
    end
  ...
  test "should update faq" do
    patch :update, id: @faq, faq: { priority: @faq.priority, published: @faq.published, text: @faq.text, title: @faq.title }
    assert_redirected_to faq_path(assigns(:faq))
  end
